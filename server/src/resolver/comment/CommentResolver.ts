...
export class CommentResolver {
  ...
  async comments(
    @Ctx() ctx: Context,
    @Args(() => CommentsArgs) args: CommentsArgs
  ): Promise<Comment[]> {
  ...
  async updateCommentVote(
    @Ctx() ctx: Context,
    @Arg('input', () => UpdateCommentVoteInput) input: UpdateCommentVoteInput,
    @PubSub(SubscriptionTopic.CommentChanged)
    notifyCommentChanged: Publisher<ChangePayload>
  ): Promise<Comment> {
  ...
  async pinComment(
    @Ctx() ctx: Context,
    @Arg('input', () => PinCommentInput) input: PinCommentInput,
    @PubSub(SubscriptionTopic.CommentChanged)
    notifyCommentChanged: Publisher<ChangePayload>
  ): Promise<Comment> {
  ...
  async unpinComment(
    @Ctx() ctx: Context,
    @Arg('input', () => UnpinCommentInput) input: UnpinCommentInput,
    @PubSub(SubscriptionTopic.CommentChanged)
    notifyCommentChanged: Publisher<ChangePayload>
  ): Promise<Comment> {
